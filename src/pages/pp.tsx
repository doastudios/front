    ...
    <Layout>
      <div className="h-full mt-64 grid grid-flow-row gap-4">
        ...
        <p>
          ...
          payment instrument. All payment data is stored by Shopify. You may
        ...
        <p>
          <em>
            ...
            mobile device, and Facebook permissions when you use our App.
          </em>
        </p>
        ...
        <p>
          ...
          below headed &quot;HOW DO WE HANDLE YOUR SOCIAL LOGINS&quot; for
          further information.
        </p>
        <p>
          ...
          contact us at max@doastudios.co and be sure to include your name,
        ...
        <p>
          ...
          details provided in the section below titled &quot;HOW CAN YOU CONTACT
        ...
        <p>
          ...
          Search, Google Calendar widget , Google Fonts, GitHub social plugins
          and Vimeo video
        </p>
        ...
        <p>
          Retargeting Platforms Adobe Audience Manager, Facebook Custom
          Audience, Facebook Remarketing, Google Ads Remarketing , Google
          Analytics Remarketing, LinkedIn Website Retargeting, Twitter
          Remarketing, Twitter Tailored Audiences and Salesforce DMP
        </p>
        <p>
        ...
        <p>
          ...
          Google Tag Manager, Livefyre, Segment, Webtrekk Tag Integration and
          Muut
        </p>
        <p>
        ...
        <p>
          Website Performance Monitoring Web Performance, Firebase Crash
          Reporting and Airbrake
        </p>
        <p>
          Website Testing Google Website Optimizer , Adobe Target , Visual
          Website Optimizer , Google Play Console, Firebase Remote Config,
          Cloudflare and Hotjar
        </p>
        <ol>
        ...
        <p>
          This Website or App uses Google Maps Platform APIs which are subject
          to Google&#39;s Terms of Service. You may find the Google Maps
          Platform Terms of Service here. To find out more about Google&#39;s
          Privacy Policy, please refer to this link. We obtain and store on your
        ...
        <p>
          ...
          to make public on such social media platform. If you login using
        ...
        <p>
          ...
          will require us keeping your personal information for longer than two
          (2) months past the start of idle period of the user&#39;s account.
        </p>
        <p>
        ...
        <p>
          ...
          please contact us at max@doastudios.co.
        </p>
        <ol>
        ...
        <p>
          You may contact us by email at max@doastudios.co, or by referring to
        ...
        <p>
          ...
          max@doastudios.co, or by referring to the contact details at the
        ...
        <p>
          ...
          our Data Protection Officer (DPO), Robert Maxwell Matson, by email at
        ...
        <p>
          ...
          submit a request form by clicking here. We will respond to your
