...
const PP = () => {
  return (
    <div className="h-full mt-64">
      ...
      <p>
        Thank you for choosing to be part of our community at DOA Studios LLC,
        doing business as DOA Magazine (&quot;DOA Magazine&quot;,
        ...
        at max@doastudios.co.
      </p>
      <p>
        When you visit our website{" "}
        <a href="http://doamagazine.com">http://doamagazine.com</a> (the
        &quot;Website&quot;), use our mobile application, use our Facebook
        application, as the case may be (the &quot;App&quot;) and more
        generally, use any of our services (the &quot;Services&quot;, which
        include the Website and App), we appreciate that you are trusting us
      ...
      <p>
        Personal Information Provided by You. We collect email addresses;
        billing addresses; debit/credit card numbers; contact or authentication
        data; names; phone numbers; and other similar information.
      </p>
      <p>
        ...
        instrument. All payment data is stored by Shopify. You may find their
      ...
      <p>
        <em>
          ...
          device, and Facebook permissions when you use our App.
        </em>
      </p>
      ...
      <p>
        ...
        App, we may also collect information about the phone network associated
      ...
      <p>
        Facebook Permissions. We by default access your Facebook basic account
        information, including your name, email, gender, birthday, current city,
        and profile picture URL, as well as other information that you choose to
        make public. We may also request access to other permissions related to
        your account, such as friends, checkins, and likes, and you may choose
        to grant or deny us access to each individual permission. For more
        information regarding Facebook permissions, refer to the Facebook
      ...
      <p>
        ...
        the performance of the contract. See the section below headed &quot;HOW
      ...
      <p>
        ...
        max@doastudios.co and be sure to include your name, testimonial
      ...
      <p>
        ...
        part of our efforts to keep our Services safe and secure (for example,
      ...
      <p>
        ...
        or otherwise contacting us, we will collect personal information from
      ...
      <p>
        ...
        third parties who do so) tailored to your interests and/or location and
      ...
      <p>
        ...
        collect data on our behalf about how you interact with our Services over
        ...
        features, and better understand online activity. Unless described in
        this notice, we do not share, sell, rent or trade any of your
      ...
      <p>
        ...
        users of our Services and register for our Services through a social
      ...
      <p>
        ...
        provided in the section below titled &quot;HOW CAN YOU CONTACT US ABOUT
        THIS NOTICE?&quot;.
      </p>
      <p>
        Advertising, Direct Marketing, and Lead Generation Facebook Audience
        Network and Google AdSense
      </p>
      <p>
        Allow Users to Connect to Their Third-Party Accounts Google account,
        Facebook account, Instagram account and Twitter account
      </p>
      <p>Cloud Computing Services Amazon Web Services (AWS)</p>
      <p>
        Communicate and Chat with Users Facebook Customer Chat and Klaviyo and
        MailChimp
      </p>
      <p>
        Content Optimization Instagram embed, YouTube video embed, Google Site
        Search, Google Calendar widget , Google Fonts, GitHub social plugins and
        Vimeo video
      </p>
      <p>Data Backup and Security Google Drive Backup and Dropbox Backup</p>
      <p>
        Functionality and Infrastructure Optimization Amazon Web Services,
        Heroku and Termly.io
      </p>
      <p>
        Invoice and Billing Shopify, Apple Pay, Affirm, Klarna, Stripe and
        PayPal
      </p>
      <p>
        Retargeting Platforms Adobe Audience Manager, Facebook Custom Audience,
        Facebook Remarketing, Google Ads Remarketing , Google Analytics
        Remarketing, LinkedIn Website Retargeting, Twitter Remarketing, Twitter
        Tailored Audiences and Salesforce DMP
      </p>
      <p>
        Social Media Sharing and Advertising Buffer social plugins, Facebook
        advertising, Facebook social plugins, Google Friend Connect , LinkedIn
        advertising, Instagram advertising, LinkedIn social plugins, Pinterest
        advertising, PayPal plugins, Pinterest social plugins, Google+ social
        plugins, YouTube social plugins, Twitter advertising, Twitter social
        plugins, Snapchat advertising and Reddit plugins
      </p>
      <p>
        User Account Registration and Authentication Facebook Login, GitHub
        OAuth, Google OAuth 2.0, Google Smart Lock, Instagram Authentication,
        Google Sign-In, MailChimp OAuth2, Twitter OAuth, YouTube OAuth 2.0,
        Pinterest OAuth 2.0, Log In with PayPal and Login with Amazon
      </p>
      <p>
        User Commenting and Forums Facebook Comments, Disqus, IntenseDebate,
        Google Tag Manager, Livefyre, Segment, Webtrekk Tag Integration and Muut
      </p>
      <p>
        Web and Mobile Analytics Adobe Analytics, AdEspresso, Facebook Ads
        conversion tracking, Facebook Analytics, Google Analytics, Google Tag
        Manager, Salesforce Analytics Cloud and SumoMe Content Analytics
      </p>
      <p>Website Hosting Shopify</p>
      <p>
        Website Performance Monitoring Web Performance, Firebase Crash Reporting
        and Airbrake
      </p>
      <p>
        Website Testing Google Website Optimizer , Adobe Target , Visual Website
        Optimizer , Google Play Console, Firebase Remote Config, Cloudflare and
        Hotjar
      </p>
      <ol>
      ...
      <p>
        This Website or App uses Google Maps Platform APIs which are subject to
      ...
      <p>
        ...
        public on such social media platform. If you login using Facebook, we
        may also request access to other permissions related to your account,
        such as your friends, check-ins, and likes, and you may choose to grant
        or deny us access to each individual permission.
      </p>
      <p>
      ...
      <p>
        ...
        require us keeping your personal information for longer than two (2)
      ...
      <p>
        ...
        contact us at max@doastudios.co.
      </p>
      <ol>
      ...
      <p>
        ...
        registered account with a Service, you have the right to request removal
      ...
      <p>
        DOA Studios LLC collects and shares your personal information through:
      </p>
      ...
      <p>
        You may contact us by email at max@doastudios.co, or by referring to the
      ...
      <p>
        DOA Studios LLC has disclosed the following categories of personal
      ...
      <p>
        ...
        max@doastudios.co, or by referring to the contact details at the bottom
      ...
      <p>
        ...
        Data Protection Officer (DPO), Robert Maxwell Matson, by email at
        max@doastudios.co, by phone at 5135570127, or by post to:
      </p>
      <p>DOA Studios LLC</p>
      <p>Robert Maxwell Matson</p>
      <p>182 Miami Ave</p>
