...
function Index(_props: Props): ReactElement {
  ...
  const togglePopup = (popups: Array<Popup>, id: number) => {
    setPopups(
      popups.reduce((acc: Array<Popup>, each: Popup) => {
        return [
          ...acc,
          {
            ...each,
            active: each.id === id ? !each.active : each.active,
          },
        ];
      }, []) as Array<Popup>
    );
  ...
  return (
    <Layout>
      ...
      <div className="grid grid-flow-row">
        ...
        <div className="w-full h-screen full-bleed  bg-cover overflow-hidden">
          <Parallax
          ...
          >
            <div className="h-screen flex">
              <div className="z-10 h-5/6 m-auto gap-2 grid grid-flow-row w-2/3">
                <div
                  className="bg-cover h-32  border border-blau flex flex-col text-white w-full"
                ...
                <div
                  className="bg-cover h-32  border border-blau w-full "
                  style={{ backgroundImage: `url(${FuturePhonk})` }}
                ></div>
                <div
                  className="bg-cover h-32  border border-blau w-full grid grid-cols-3"
                ...
                <div
                  className="bg-cover h-32  border border-blau w-full font-baskerville flex flex-col py-4 text-hurt-ur-eyes"
